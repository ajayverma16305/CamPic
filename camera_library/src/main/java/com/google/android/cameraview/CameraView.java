...
public class CameraView extends FrameLayout {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mAdjustViewBounds) {
            ...
            if (widthMode == MeasureSpec.EXACTLY && heightMode != MeasureSpec.EXACTLY) {
                int height = getHeight(widthMeasureSpec, heightMeasureSpec, heightMode);
                super.onMeasure(widthMeasureSpec,
                        MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY));
            } else if (widthMode != MeasureSpec.EXACTLY && heightMode == MeasureSpec.EXACTLY) {
                int width = getHeight(heightMeasureSpec, widthMeasureSpec, widthMode);
    ...
    private int getHeight(int widthMeasureSpec, int heightMeasureSpec, int heightMode) {
